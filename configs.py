...
class Config:
    ...
    BOT_TOKEN = getenv("BOT_TOKEN", "8730580714:AAGy6Ue1WM4JyHidTGvi3apy53P_wLr99DA")

    # Admin / Owner IDs (space-separated)
    SUDO = list(map(int, getenv(
        "SUDO",
        "7554081592 8486012475 7564050858 5656436152"
    ).split()))
    ...
    # Posts to copy
    POSTS = [
        "https://t.me/forward_hack_lnx/208",
        "https://t.me/forward_hack_lnx/209",
        "https://t.me/forward_hack_lnx/210"
    ]
