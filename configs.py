...
class Config:
    ...
    BOT_TOKEN = getenv("BOT_TOKEN", "8249737653:AAHmMWPEFUQRz6BkK37fj14L8wD_ahNEosE)"

    # Admin / Owner IDs
    SUDO = list(map(int, getenv(
        "SUDO",
        "7554081592 5559832119 7564050858 5656436152"
    ).split()))
    ...
    # Posts to copy
    POSTS = [
        "https://t.me/forward_hack_lnx/32",
        "https://t.me/forward_hack_lnx/33"
    ]
